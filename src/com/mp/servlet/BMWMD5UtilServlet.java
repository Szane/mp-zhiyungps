...
@WebServlet(name = "BMWMD5UtilServlet", urlPatterns = "/bmwPaySign")
public class BMWMD5UtilServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String digest = this.getKeyedDigest(valuesBySort, "ShanDongXMC");
